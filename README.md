...
### documentation page:
The documentation lists holds all the most important information and tips on how to properly use enkripto. it shows direct workflows that one could even copy. It should be up to date most of the time. To open it, visit https://github.io/Bokrsteski/Enkripto 
